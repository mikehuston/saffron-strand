class EventsController < ApplicationController
  ...
  def create
    ...
    event_info = {:event_info => {:budget_per_person => session[:budget_per_person], :event => session[:event]}}

    redirect_to events_custom_order_path(event_info)
  end
  ...
  def save_order
    ...
    if @menu.valid?
      ...
      redirect_to events_show_path(event_info) and return
    end
